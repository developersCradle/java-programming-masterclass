...
d(A,B)=squareroot  (xB - xA) * (xB - xA) + (yB - yA) * (yB - yA)

Where squareroot represents square root.
...
NOTE: Use Math.sqrt to calculate the square root squareroot.
...
public class Point {
	...
	public double distance()
	{
		...
		double value = (xB - xA) * (xB - xA) + (yB - yA) * (yB - yA);
