...
public class Person {
	...
	/*
	 * needs to return true if the value of the age field is greater than 12 and less than 20, otherwise, return false.
	 */
    ...
    */
	public String getFullName() {
		...
		String stringToReturn = getFirstName() + " " +  getLastName();
		...
		if (this.lastName.isEmpty()) {
			stringToReturn = getFirstName();
		}
		
		if (this.firstName.isEmpty()) {
			stringToReturn = getLastName();
		}
